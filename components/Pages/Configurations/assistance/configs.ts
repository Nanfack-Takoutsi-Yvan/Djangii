...
import { assistanceDataTables } from "./methods"
...
export const assistancePageTable = {
  widthArr,
  tableHead,
  tableData: assistanceDataTables
}

export const createData: CreateData = {
  buttonTitle: "newAssistance",
  formTitle: "createNewAssistance",
