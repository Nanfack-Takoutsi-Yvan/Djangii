...
import { chargeTypesDataTables } from "./methods"
...
export const chargeTypesPageTable = {
  widthArr,
  tableHead,
  tableData: chargeTypesDataTables
}

export const createData: CreateData = {
  buttonTitle: "newChargeType",
  formTitle: "createChargeType",
