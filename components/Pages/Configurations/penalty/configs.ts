...
import { penaltiesDataTables } from "./methods"

const tableHead = ["date", "designation", "amount", "majoration", "description"]

const widthArr = Array(tableHead.length).fill(150)

export const penaltiesTypesPageTable = {
  widthArr,
  tableHead,
  tableData: penaltiesDataTables
}

export const createData: CreateData = {
  buttonTitle: "newPenaltyType",
  formTitle: "createPenaltyType",
