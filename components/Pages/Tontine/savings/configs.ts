...
import { savingsTableData } from "./methods"

export const createData: CreateData = {
  buttonTitle: "newSavingTontine",
  formTitle: "createSavingTontine",
...
const tableHead = [
  ...
  "frequency",
  "paymentDeadlineFrequency"
]

const widthArr = Array(tableHead.length).fill(150)

export const savingsContributionTable = {
  widthArr,
  tableHead,
