...
import { fixedAmountTableData } from "./methods"

export const createData: CreateData = {
  buttonTitle: "newFixedAmountTontine",
  formTitle: "createFixedAmountTontine",
...
export const fixedAmountContributionTable = {
  widthArr,
  tableHead,
  tableData: fixedAmountTableData
}
