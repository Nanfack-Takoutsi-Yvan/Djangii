...
import { assistanceRequestsTableData } from "./methods"

export const createData: CreateData = {
  buttonTitle: "newAssistanceRequest",
  formTitle: "createAssistanceRequest",
...
export const assistanceRequestTable = {
  widthArr,
  tableHead,
  tableData: assistanceRequestsTableData
}
