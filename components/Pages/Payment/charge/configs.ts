...
import { chargePaymentTableData } from "./methods"

export const createData: CreateData = {
  buttonTitle: "newChargePayment",
  formTitle: "createChargePayment",
...
export const chargePaymentTable = {
  widthArr,
  tableHead,
  tableData: chargePaymentTableData
}
