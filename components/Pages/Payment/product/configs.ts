...
import { productsPaymentTableData } from "./methods"

export const createData: CreateData = {
  buttonTitle: "newProductPayment",
  formTitle: "createProductPayment",
...
export const productsPaymentTable = {
  widthArr,
  tableHead,
  tableData: productsPaymentTableData
}
